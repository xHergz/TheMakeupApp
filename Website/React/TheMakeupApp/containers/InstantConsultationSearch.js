...
export default InstantConsultationSearch;
  /*  constructor(props) {
    ...
    componentWillMount() {
        this.props.setCurrentPage(PAGES.INSTANT_CONSULTATION_SEARCH.KEY);
    ...
    searchArtists(currentLocation) {
        ...
        this.props.searchForArtists(
            ...
            INSTANT_CONSULTATION.SERVICE_TYPE_ID,
    ...
    requestAppointment(artistPortfolioId, artistDisplayName, servicePrice, artistServiceId) {
        ...
        this.props.goToMakeoverAppointmentSetup(artistPortfolioId, artistDisplayName, makeoverTypeId, makeoverTypeDescription,
            INSTANT_CONSULTATION.SERVICE_TYPE_ID, INSTANT_CONSULTATION.SERVICE_TYPE_DESCRIPTION, servicePrice, artistServiceId);
    }
    ...
    render() {
        ...
        return (
            <div className="page-container">
                <h1 className="page-title">Instant Consultation Search</h1>
                <InfoBlock
                    message={'An Instant Consultation is a real time video chat with an Artist to get help with anything makeup related. '
                        + 'Some examples include help with looks you are trying to achieve, general makeover advice, product recommendations, etc. '}
                />
                <DropdownInput
...
InstantConsultationSearch.propTypes = {
