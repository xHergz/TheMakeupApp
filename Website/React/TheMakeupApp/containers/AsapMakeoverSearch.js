...
const ASAP_MAKEOVER = {
    SERVICE_TYPE_ID: 2,
    SERVICE_TYPE_DESCRIPTION: 'ASAP Makeover'
};
...
class AsapMakeoverSearch extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            didSearch: false,
    ...
    componentWillMount() {
        this.props.setCurrentPage(PAGES.ASAP_MAKEOVER_SEARCH.KEY);
    ...
    requestAppointment(artistPortfolioId, artistDisplayName, servicePrice, artistServiceId) {
        ...
        this.props.goToMakeoverAppointmentSetup(artistPortfolioId, artistDisplayName, makeoverTypeId, makeoverTypeDescription,
            ASAP_MAKEOVER.SERVICE_TYPE_ID, ASAP_MAKEOVER.SERVICE_TYPE_DESCRIPTION, servicePrice, artistServiceId);
    }
