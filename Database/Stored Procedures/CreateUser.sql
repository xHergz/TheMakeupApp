...
BEGIN
    ...
    CreateUser:BEGIN
        ...
        CALL AddTaskUserNotification(_displayName, 'Welcome to The Makeup Application! Click here to set up your client profile.', CONCAT('/profile/', _displayName), @status);
        SET _status = 0;
    END;
